...
//           <mat-error *ngIf="personalDetailsControl.firstName.errors?.['required']">First Name is required</mat-error>
//           <mat-error
...
//           <mat-error *ngIf="personalDetailsControl.lastName.errors?.['pattern']">Enter the correct last name</mat-error>
//         </mat-form-field>
//         <mat-form-field>
...
//           <mat-radio-button class="gender" value="Female" matInput color="primary" value="2">Female</mat-radio-button>
//         </mat-radio-group>
...
//       <mat-hint>NOTE: First letter of the every input should be capital</mat-hint>
//       <form [formGroup]="academicDetails" linear>
//         <ng-template matStepperIcon="edit">
//           <mat-icon>check_circle_outline</mat-icon>
//         </ng-template>
//         <mat-form-field>
...
//           </mat-error>
//           <mat-error *ngIf="academicDetailsControl.collegeStudy.errors?.['pattern']">Enter the field of study correctly
//           </mat-error>
//         </mat-form-field>
//         <mat-form-field>
//           <mat-label>College Location</mat-label>
//           <input matInput formControlName="collegeLocation" required>
//           <mat-error *ngIf="academicDetailsControl.collegeLocation.errors?.['required']">College Location is required
//           </mat-error>
...
//           <mat-error *ngIf="academicDetailsControl.schoolName.errors?.['required']">School Name is required</mat-error>
...
//               </button>
//             </mat-chip>
//             <input placeholder="Technical Skills..." [matChipInputFor]="techSkillList" formControlName="technicalSkill"
//               [matChipInputSeparatorKeyCodes]="separatorKeysCodes" [matChipInputAddOnBlur]="addOnBlur"
//               (matChipInputTokenEnd)="addTechSkills($event)">
//           </mat-chip-list>
...
//             <mat-icon>keyboard_arrow_up</mat-icon>
//           </button>
//           <button mat-mini-fab color="primary" (click)="generatePDF()" class="next-button" matStepperNext>
//             <mat-icon>keyboard_arrow_down</mat-icon>
//           </button>
//         </div>
//       </form>
//     </mat-step>
//     <mat-step [stepControl]="additionalDetails" label="Additional Details" errorMessage="Some Fields are still empty">
...
//           <mat-error *ngIf="additionalDetailsControl.githubURL.errors?.['required']">GitHub URL is required</mat-error>
...
//           <mat-error *ngIf="additionalDetailsControl.linkedInURL.errors?.['required']">linkedIn URL is required</mat-error>
//           <!-- <mat-error *ngIf="additionalDetailsControl.githubURL.errors?.['minlength']">Must be 4 characters long</mat-error> -->
//         </mat-form-field>
//         <mat-form-field appearance="fill" id="profile-picture-form-field">
//           <mat-label>Profile Picture</mat-label>
//           <ngx-mat-file-input formControlName="profilePicture" type="file" (change)="load($event)" #removableInput required></ngx-mat-file-input>
//           <button mat-icon-button matSuffix *ngIf="!removableInput.empty" (click)="removableInput.clear($event)"><mat-icon matSuffix>clear</mat-icon></button>
//           <mat-icon *ngIf="removableInput.empty" matSuffix>folder</mat-icon>
//           <mat-error *ngIf="removableInput.empty || additionalDetailsControl.profilePicture.errors?.['required']">Profile Picture is required</mat-error>
//         </mat-form-field>
//         <img [src]="imageUrl" height="200">
//       </form>

//       <div>
//         <button mat-mini-fab color="primary" class="previous-button" (click)="setDetails()" matStepperPrevious>
//           <mat-icon>keyboard_arrow_up</mat-icon>
//         </button>
//         <button mat-button color="primary" class="next-button" (click)="showSwalFire()" matStepperNext>Finish</button>
//       </div>
